...
users = pd.read_csv("../ai-recommendation-engine/data/processed/users_clean.csv") 
products = pd.read_csv("../ai-recommendation-engine/data/processed/products_clean.csv")
...
#Creating 16000 interactions data
