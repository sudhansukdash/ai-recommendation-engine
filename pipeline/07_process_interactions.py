...
print("\n1. Starting interaction data cleaning...")
...
print("2. Grouping identical rows...")
...
print("3. Converting interactions_type to float...")
...
print("4. Dropping redundant columns...")
...
grouped_interactions = clean_interactions.groupby(["user_id", "pr_id"], as_index=False).agg(total_scores=("scores", "sum"))
# print(grouped_interactions.head())

print("5. Clipping scores...")
...
print("\nInteraction data remodelled successfully!")
print(grouped_interactions.info())

#Saving this clean_interactions dataframe into a new interactions_final.csv file
grouped_interactions.to_csv("data/processed/interactions_final.csv", index=False)

print(f"File saved as interactions_final.csv under {PROJECT_ROOT}/data/processed/")